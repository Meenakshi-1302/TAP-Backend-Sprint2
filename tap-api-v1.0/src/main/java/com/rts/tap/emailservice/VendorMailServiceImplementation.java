	...
	public String sendVendorCredentials(VendorDto vendorDto) throws MessagingException {
		...
		try {
			...
			String htmlContent = "<html>"
					...
					+ "<p><strong>Username:</strong> " + vendorDto.getVendorUsername() + "</p>"
					...
					+ closingDiv
					+ "<p style='font-size: 16px; line-height: 1.6; color: #6e6e73;'>Thank you for collaborating with us. We look forward to welcoming exceptional talent to [Your Company Name].</p>"
					// Footer
					+ "<div class='footer' style='text-align: center; font-size: 14px; color: #86868b; margin-top: 30px;'>"
					+ "<p>Best regards,<br>[Your Name]<br>[Your Position]<br>[Your Company Name]</p>" + closingDiv
